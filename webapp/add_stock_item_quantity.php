...
<head>
	...
	<script src="script/quantity_update_validation.js"></script>
</head>
			...
			<div class="col-md-12">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<!-- form -->
						<form id="new_record" method="post" action="update_quantity_process.php">
							<fieldset>
								...
								<tr>
									<div class="form-group">
										...
										<td>
											<div class="col-lg-10">
												<input type="text" class="form-control" id="quantity" name="quantity" placeholder="e.g. 10" />
											</div>
										</td>
									</div>
								</tr>
